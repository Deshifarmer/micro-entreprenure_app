...
class SelectFarmerPaginateForFarm extends StatefulWidget {
  const SelectFarmerPaginateForFarm({
  ...
  @override
  State<SelectFarmerPaginateForFarm> createState() =>
      _SelectFarmerPaginateForFarmState();
}

class _SelectFarmerPaginateForFarmState
    extends State<SelectFarmerPaginateForFarm> {
                  ...
                  builderDelegate: PagedChildBuilderDelegate<FarmerEntity>(
                    itemBuilder: (context, farmer, index) {
                      return InkWell(
                        onTap: () async {
                          context
                              .read<SelectPaginatedFarmerCubit>()
                              .selectFarmer(
                                farmer,
                              );
