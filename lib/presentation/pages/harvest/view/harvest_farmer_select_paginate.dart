...
class HarvestFarmerSelectPaginate extends StatefulWidget {
  const HarvestFarmerSelectPaginate({
    required this.cropList,
    required this.units,
    super.key,
  });

  final List<SingleCropEntity> cropList;
  final List<UnitEntity> units;

  @override
  State<HarvestFarmerSelectPaginate> createState() =>
      _HarvestFarmerSelectPaginateState();
}

class _HarvestFarmerSelectPaginateState
    extends State<HarvestFarmerSelectPaginate> {
                        ...
                        await Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) => HarvestRecordPage2(
                              crops: widget.cropList,
                              allFarmerListResp: farmer,
                              units: widget.units,
                            ),
                          ),
                        );
