...
class FarmerVillageAddressForHarvest extends StatefulWidget {
  const FarmerVillageAddressForHarvest({
    ...
    required this.farmerUpozelaNameController,
    super.key,
  });
  final TextEditingController farmerDivisionController, farmerUpozelaNameController;
            ...
            child: DropdownButtonFormField<UpozillaModel>(
              ...
              onChanged: (UpozillaModel? val) {
                ...
                if (val != null) {
                  ...
                  widget.farmerUpozelaNameController.text = val.name;
                }
                setState(() {
