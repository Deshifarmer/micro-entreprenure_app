...
class LogisticShape extends CustomPainter {
  @override
  void paint(Canvas canvas, Size size) {
    final path_0 = Path();
    path_0.moveTo(size.width * 0.7883333, size.height * 0.2087500);
    path_0.cubicTo(
    ...
    path_0.close();
    path_0.moveTo(size.width * 0.2854167, size.height * 0.2500000);
    path_0.lineTo(size.width * 0.7141667, size.height * 0.2500000);
    path_0.lineTo(size.width * 0.7575000, size.height * 0.3750000);
    path_0.lineTo(size.width * 0.2420833, size.height * 0.3750000);
    path_0.lineTo(size.width * 0.2854167, size.height * 0.2500000);
    path_0.close();
    path_0.moveTo(size.width * 0.2083333, size.height * 0.6666667);
    path_0.lineTo(size.width * 0.7916667, size.height * 0.6666667);
    path_0.lineTo(size.width * 0.7916667, size.height * 0.4725000);
    path_0.lineTo(size.width * 0.7870852, size.height * 0.4583333);
    path_0.lineTo(size.width * 0.2133333, size.height * 0.4583333);
    path_0.lineTo(size.width * 0.2083333, size.height * 0.4725000);
