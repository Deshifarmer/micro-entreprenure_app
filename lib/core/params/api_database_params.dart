...
class ApiDatabaseParams {
  ...
  static String loginApi =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/login';

  ///! logout api
  static String logoutApi =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/logout';

  ///! my profile api
  static String profileApi =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/my_profile';

  ///! add farmer api
  static String addFarmerApi =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/add_farmer';
  ...
  static String inputerOrderApi =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/input_order';
  ...
  static String companyListAPI =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/all_company';

  ///! cateogry list api
  static String categoryListAPI =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/all_category';

  ///! Product List api
  static String productListAPI =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/product/sort';

  ///! Product List api PAGINATION
  static String productListPaginationAPI =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/product/sort?page=';
  ...
  static String farmAddAPI =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/add_farm';

  ///! assign a farmer
  static String assignFarmerToGroup(String groupID) =>
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/farmer_group/$groupID/assign';
  // 'https://core.deshifarmer.co/api/v1/me/farmer_group/FG-10a2-48c21/assign'

  ///! assign a farmer
  static String updateLeaderToGroup(String groupID) =>
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/farmer_group/$groupID';

  ///! attendance api (check in/out api)
  static String checkinAPI =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/attendance';

  ///! attendance api (todays attendanc3)
  static String todaysAttendanceAPI =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/todays_attendance';

  ///! attendance api (todays attendanc3)
  static String attendanceHistory =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/attendance_history';

  /// comission aka (all transaction)
  static String comissionAPI =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/all_transaction';
  ...
  static String batchCreationAPI =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/batch'; //*POST
  //! get batch list api
  static String batchListAPI =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/farm_batch'; //*GET
  ...
  static String harvestLandPrepPost =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/land_preparation'; //*POST
  ///* get sowing
  ...
  static String irrigationPost =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/watering'; //*POST
  //* get; fertilization
  static String fertilizationPost =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/fertilization'; //*POST
  //* get pesticide
  static String pesticidePost =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/pesticide'; //*POST

  //! get latest batch list api
  static String latestbatchListAPI =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/my_batch'; //*GET

  //! get batch Info
  static String getBatchInfo =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/batch'; //*GET

  //! get post Logistic api
  static String postLogisticAPI =
      '${Strings.getServerOrLocal(ServerOrLocal.local)}/api/v1/me/logistic'; //*POST
}
